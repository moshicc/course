            ...
            <form class="form-horizontal">
                <#list fieldList as field>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select v-model="${domain}.${field.nameHump}" type="text" class="form-control" >
    ...
    export default {
        ...
        methods:{
            ...
            save(page) {
                ...
                Loading.show();
                _this.$ajax.post(process.env.VUE_APP_SERVER+"/${module}/admin/${domain}/save", _this.${domain}).then((resopnes)=>{
                    Loading.hide();
                    let resp = resopnes.data;
                    if(resp.success){
            ...
            del(id) {
                ...
                Confirm.show("删除${tableNameCn}后不可恢复，确认删除？",function () {
                    Loading.show();
                    _this.$ajax.delete(process.env.VUE_APP_SERVER+"/${module}/admin/${domain}/delete/"+id).then((resopnes)=>{
                        Loading.hide();
                        let resp = resopnes.data;
                        if(resp.success){
                            //删除成功，并且刷新list
