        ...
        <div class="footer-inner">
          <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">zcc</span>
							在线视频网站 &copy; 2019-2099
						</span>
    ...
    export default {
        ...
        mounted:function(){
          ...
          $route: {
              handler:function (val,oldVal) {
                  ...
                  let _this =this;
                  _this.$nextTick(function () {//页面加载完毕后执行
                      _this.activeSidebar(_this.$route.name.replace("/","-")+"sidebar");
                  })
              }
          }
        ...
        methods:{
            ...
            activeSidebar: function (id) {
                ...
                $("#"+id).addClass("active")
                //如果有父菜单，父菜单的兄弟菜单去掉open active ，父菜单增加 open actvie
