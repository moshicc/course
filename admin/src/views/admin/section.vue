    ...
    export default {
        ...
        methods:{
            ...
            save(page) {
                ...
                Loading.show();
                _this.$ajax.post(process.env.VUE_APP_SERVER+"/business/admin/section/save", _this.section).then((resopnes)=>{
                    Loading.hide();
                    let resp = resopnes.data;
                    if(resp.success){
            ...
            del(id) {
                ...
                Confirm.show("删除小节后不可恢复，确认删除？",function () {
                    Loading.show();
                    _this.$ajax.delete(process.env.VUE_APP_SERVER+"/business/admin/section/delete/"+id).then((resopnes)=>{
                        Loading.hide();
                        let resp = resopnes.data;
                        if(resp.success){
                            //删除成功，并且刷新list
